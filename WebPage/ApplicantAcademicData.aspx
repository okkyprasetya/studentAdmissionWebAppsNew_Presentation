<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ApplicantAcademicData.aspx.vb" Inherits="WebPage.ApplicantAcademicData" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Panel ID="pnlAboutMeForm" runat="server" Visible="true">
                                ...
                                <div class="form-group">
                                    <label for="txtRaportSumm">Raport Summaries</label>
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtRaportSum" placeholder="Enter your mid-school raport summaries" ReadOnly="true" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorRaportSum" runat="server" ControlToValidate="txtRaportSum" ErrorMessage="Raport Summaries is required." CssClass="validation-error" ValidationGroup="GeneralDataValidation"/>
                                </div>
                                <div class="form-group">
                                    <label for="txtRaportDocument">Raport Document</label>
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtRaportDocument" placeholder="Enter your raport document" ReadOnly="true" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorRaportDocument" runat="server" ControlToValidate="txtRaportDocument" ErrorMessage="Raport document is required." CssClass="validation-error" ValidationGroup="GeneralDataValidation"/>
                                </div>
